...
A Blender plugin for importing and exporting data from **Max Payne** and **Max Payne 2**, including **LVL**, **LDB**, **KFS**, **KF2**, and **SKD** files.
...
| **LDB** | `.ldb` | **Compiled maps** — optimized level files ready for the game engine. | ✅ Supported |
